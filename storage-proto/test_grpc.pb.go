...
func (c *testApiClient) AddUser(ctx context.Context, in *AddUserInput, opts ...grpc.CallOption) (*AddUserOutput, error) {
	out := new(AddUserOutput)
	err := c.cc.Invoke(ctx, "/main.TestApi/AddUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testApiClient) GetUser(ctx context.Context, in *GetUserInput, opts ...grpc.CallOption) (*GetUserOutput, error) {
...
func (UnimplementedTestApiServer) AddUser(context.Context, *AddUserInput) (*AddUserOutput, error) {
...
func _TestApi_AddUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddUserInput)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestApiServer).AddUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.TestApi/AddUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestApiServer).AddUser(ctx, req.(*AddUserInput))
	}
...
func _TestApi_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestApiServer).GetUser(ctx, req.(*GetUserInput))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TestApi_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AddUser",
			Handler:    _TestApi_AddUser_Handler,
		},
		{
			MethodName: "GetUser",
